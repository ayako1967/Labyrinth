...
public class LabyrinthGenerator {
    ...
    public static int[][] getMap(
            int horizontalBlockCount,int verticalBlockCount,int seed) {
*/

        public static MapResult getMap(
        int horizontalBlockCount,int verticalBlockCount,int seed) {
    ...
    private static int[][] calcStep(
            int[][] map,int x,int y,int [][] result,int score) {
        score++;
    ...
    private static int[][] generateLabyrinth(
            int horizontalBlockCount,int verticalBlockCount,int [][] map,int seed) {
        ...
        for (int y = 0;y < verticalBlockCount;y++) {
            for (int x = 0;x<horizontalBlockCount;x++) {
                if (map[y][x] == INNER_WALL) {
                    ...
                    do {
                        Direction direction =
                                directionList.get(rand.nextInt(directionList.size()));
